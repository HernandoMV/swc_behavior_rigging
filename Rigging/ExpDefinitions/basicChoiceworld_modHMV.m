function basicChoiceworld_modHMV(t, events, parameters, visStim, inputs, outputs, audio)
...
audio.tone1 = toneSamples.at(interactiveOn);

% Response
% (wheel displacement zeroed at interactiveOn)
stimDisplacement = -250*wheelGain*millimetersFactor*(wheel - wheel.at(interactiveOn));
...
% Play noise on miss
audio.tone2 = missNoiseSamples.at(trialData.miss.delay(0.01));
