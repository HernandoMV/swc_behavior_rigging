function signals_tutorial_pong_example_HMV(t, events, pars, visStim, inputs, outputs, audio)
% This is a working example of  pong in signals
% 170328 - AP 

%% Set up the wheel 
wheel_raw = 25*inputs.wheel;
%filter to avoid flickering
wheel = wheel_raw.map(@floor).skipRepeats;
...
paddle_size = [3,15];
player_paddle_azimuth = 80;
computer_paddle_azimuth = -80;
...
if player_paddle_altitude > 30
    player_paddle_altitude = 30;
elseif player_paddle_altitude < -30
    player_paddle_altitude = -30;
end
